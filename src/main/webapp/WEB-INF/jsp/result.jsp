        ...
        <div>
            ...
            <ul class="pagination pagination-lg">
                <c:if test="${page.hasPreviousPage}">
                    <li><a href="/career/findByKeyWord?pageNum=${page.prePage}&keyWord=${keyWord}">&laquo;</a></li>
                </c:if>
                <c:forEach items="${page.navigatepageNums}" var="nav">
                    <c:if test="${nav == page.pageNum}">
                        <li style="font-weight: bold;"><a
                                href="/career/findByKeyWord?pageNum=${nav}&keyWord=${keyWord}">${nav}</a></li>
                    </c:if>
                    <c:if test="${nav != page.pageNum}">
                        <li><a href="/career/findByKeyWord?pageNum=${nav}&keyWord=${keyWord}">${nav}</a></li>
                    </c:if>
                </c:forEach>
                <c:if test="${page.hasNextPage}">
                    <li><a href="/career/findByKeyWord?pageNum=${page.nextPage}&keyWord=${keyWord}">&raquo;</a></li>
                </c:if>
            </ul>
        </div>
    </div>
