...
public class Indexer {
    ...
    public void indexWriter(List<CareerInfo> careerInfos) throws Exception {
        ...
        for (CareerInfo careerInfo : careerInfos) {
            ...
            document.add(new StringField("id", String.valueOf(careerInfo.getId()), Field.Store.YES));
            document.add(new StringField("school", careerInfo.getSchool(), Field.Store.YES));
            document.add(new TextField("title", careerInfo.getTitle(), Field.Store.YES));
//            document.add(new TextField("content", careerInfo.getContent(), Field.Store.NO));
